...
let data=products.map(function(value)
{return` 
  <button class="company-btn">${value.company}</button>
`});


  document.getElementById("products").innerHTML = d.join("");

  document.getElementById("companies").innerHTML = data.join("");